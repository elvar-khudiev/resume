        ...
        <div style="float: left; margin-top: -172px;">
            <form action="users" method="GET">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="surname" id="surname" placeholder="Enter surname" value=""/>
                </div>
            ...
            <tr>
                ...
                <td style="width: 1px">
                    <form action="user-details" method="GET">
                        <input type="hidden" name="id" value="<%=u.getId()%>">
                        <button class="btn_table btn-info" style="border-radius: 20px; font-size: 20px;" type="submit" value="info"  onclick="test()">
