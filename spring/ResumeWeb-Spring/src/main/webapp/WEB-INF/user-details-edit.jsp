    ...
    <div class="dt-container">
        <form action="user-details-edit" method="POST" style="margin-bottom: 75px;">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" rows="10" name="profile-description"><%=u.getProfileDescription()%></textarea>
            </div>
            ...
            <div class="div-3">
                ...
                <div class="div-side-by-side birth-date">
                    ...
                    <input style="padding-left: 5px; margin-top: 8px;" type="text" id="from-datepicker" name="datepicker" value="<%=dateStr%>" placeholder="Select birthdate"/>
                </div>
                ...
                <div class="div-side-by-side">
                    ...
                    <select name="birthPlace" class="input-xlarge">
                        <option value="<%=u.getBirthPlace().getName()%>" selected="selected"><%=u.getBirthPlace().getName()%></option>
                ...
                <div class="div-side-by-side">
                    ...
                    <select name="nationality" class="input-xlarge">
                        <option value="<%=u.getNationality().getNationality()%>" selected="selected"><%=u.getNationality().getNationality()%></option>
                        <% for (Country c : countryDao.getAll()) {%>
                        <option><%=c.getNationality()%></option>
                        <%}%>
                    </select>
                </div>
            </div>
