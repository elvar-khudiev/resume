        ...
        <div class="col-3">
            ...
            <form action="login" method="POST">
                <div class="form-group" style="margin: 3px 0">
                    <input type="text" class="form-control email" id="exampleInputEmail1" name="username"
                           style="border-radius: 0;" aria-describedby="emailHelp" placeholder="E-mail">
                </div>
                <div class="form-group" style="margin: 3px 0 4px 0">
                    <input type="password" class="form-control" style="border-radius: 0;" id="exampleInputPassword1"
